...
<head>
	...
	<!-- Title -->
	<title>Confer - Conference Event Ice Mine</title>

	<!-- Favicon -->
	<link rel="icon" href="./img/core-img/favicon.png">

	<!-- Stylesheet -->
	<link rel="stylesheet" href="<?= base_url('assets/'); ?>static_page/style.css">
...
<body>
		...
		<div class="classy-nav-container breakpoint-off">
			<div class="container">
				...
				<nav class="classy-navbar justify-content-between" id="conferNav">
					...
					<!-- Logo -->
					<a class="nav-brand" href="<?= base_url(); ?>"><img src="<?= base_url('assets/'); ?>static_page/img/core-img/logo.png" alt=""></a>
	...
	<section class="welcome-area">
		<div class="welcome-slides owl-carousel">
			<!-- Single Slide -->
			<div class="single-welcome-slide bg-img bg-overlay jarallax" style="background-image: url(<?= base_url('assets/'); ?>static_page/img/bg-img/1.jpg);">
			...
			<!-- Single Slide -->
			<div class="single-welcome-slide bg-img bg-overlay jarallax" style="background-image: url(<?= base_url('assets/'); ?>static_page/img/bg-img/45.jpg);">
				<div class="container h-100">
					<div class="row h-100 align-items-center">
						<!-- Welcome Text -->
						<div class="col-12">
							<div class="welcome-text-two text-center">
								...
								<div class="event-meta" data-animation="fadeInUp" data-delay="500ms">
									<a class="event-date" href="#"><i class="zmdi zmdi-account"></i> January 14,
										2019</a>
			...
			<div class="row align-items-center">
				...
				<div class="col-12 col-md-6">
					<div class="about-content-text mb-80">
						...
						<p class="wow fadeInUp" data-wow-delay="300ms">The Project Management is a platform to learn
				...
				<div class="col-12 col-md-6">
					<div class="about-thumb mb-80 wow fadeInUp" data-wow-delay="300ms">
						<img src="<?= base_url('assets/'); ?>static_page/img/bg-img/2.png" alt="">
					</div>
				</div>
			</div>
		</div>
	...
	<section class="our-speaker-area bg-img bg-gradient-overlay section-padding-100-60" style="background-image: url(<?= base_url('assets/'); ?>static_page/img/bg-img/3.jpg);">
		<div class="container">
			<div class="row">
				<!-- Heading -->
				<div class="col-12">
			...
			<div class="row">
				...
				<div class="col-12 col-md-6 col-lg-4">
					<div class="single-speaker-area bg-gradient-overlay-2 wow fadeInUp" data-wow-delay="300ms">
						...
						<div class="speaker-single-thumb">
							<img src="<?= base_url('assets/'); ?>static_page/img/bg-img/4.jpg" alt="">
						</div>
						<!-- Social Info -->
				...
				<div class="col-12 col-md-6 col-lg-4">
					<div class="single-speaker-area bg-gradient-overlay-2 wow fadeInUp" data-wow-delay="300ms">
						<!-- Thumb -->
						<div class="speaker-single-thumb">
							<img src="<?= base_url('assets/'); ?>static_page/img/bg-img/5.jpg" alt="">
						</div>
						<!-- Social Info -->
						<div class="social-info">
							<a href="#"><i class="zmdi zmdi-facebook"></i></a>
				...
				<div class="col-12 col-md-6 col-lg-4">
					<div class="single-speaker-area bg-gradient-overlay-2 wow fadeInUp" data-wow-delay="300ms">
						<!-- Thumb -->
						<div class="speaker-single-thumb">
							<img src="<?= base_url('assets/'); ?>static_page/img/bg-img/6.jpg" alt="">
						</div>
						<!-- Social Info -->
						<div class="social-info">
							<a href="#"><i class="zmdi zmdi-facebook"></i></a>
				...
				<div class="col-12 col-md-6 col-lg-4">
					<div class="single-speaker-area bg-gradient-overlay-2 wow fadeInUp" data-wow-delay="300ms">
						<!-- Thumb -->
						<div class="speaker-single-thumb">
							<img src="<?= base_url('assets/'); ?>static_page/img/bg-img/7.jpg" alt="">
						</div>
						<!-- Social Info -->
						<div class="social-info">
							<a href="#"><i class="zmdi zmdi-facebook"></i></a>
				...
				<div class="col-12 col-md-6 col-lg-4">
					<div class="single-speaker-area bg-gradient-overlay-2 wow fadeInUp" data-wow-delay="300ms">
						<!-- Thumb -->
						<div class="speaker-single-thumb">
							<img src="<?= base_url('assets/'); ?>static_page/img/bg-img/8.jpg" alt="">
						</div>
						<!-- Social Info -->
						<div class="social-info">
							<a href="#"><i class="zmdi zmdi-facebook"></i></a>
				...
				<div class="col-12 col-md-6 col-lg-4">
					<div class="single-speaker-area bg-gradient-overlay-2 wow fadeInUp" data-wow-delay="300ms">
						<!-- Thumb -->
						<div class="speaker-single-thumb">
							<img src="<?= base_url('assets/'); ?>static_page/img/bg-img/9.jpg" alt="">
						</div>
						<!-- Social Info -->
						<div class="social-info">
							<a href="#"><i class="zmdi zmdi-facebook"></i></a>
				...
				<div class="col-12">
					<div class="schedule-tab">
						...
						<ul class="nav nav-tabs wow fadeInUp" data-wow-delay="300ms" id="conferScheduleTab" role="tablist">
							<li class="nav-item">
								<a class="nav-link active" id="monday-tab" data-toggle="tab" href="#step-one" role="tab" aria-controls="step-one" aria-expanded="true">Monday <br> <span>January 14,
										2019</span></a>
							</li>
							<!-- Nav Item -->
							<li class="nav-item">
								<a class="nav-link" id="tuesday-tab" data-toggle="tab" href="#step-two" role="tab" aria-controls="step-two" aria-expanded="true">Tuesday <br> <span>January 15,
										2019</span></a>
							</li>
							<!-- Nav Item -->
							<li class="nav-item">
								<a class="nav-link" id="wednesday-tab" data-toggle="tab" href="#step-three" role="tab" aria-controls="step-three" aria-expanded="true">Wednesday <br> <span>January 16,
										2019</span></a>
							</li>
						</ul>
					</div>
									...
									<div class="col-12">
										...
										<div class="single-schedule-area d-flex flex-wrap justify-content-between align-items-center wow fadeInUp" data-wow-delay="300ms">
											...
											<div class="single-schedule-tumb-info d-flex align-items-center">
												...
												<div class="single-schedule-tumb">
													<img src="<?= base_url('assets/'); ?>static_page/img/bg-img/10.jpg" alt="">
												</div>
										...
										<div class="single-schedule-area d-flex flex-wrap justify-content-between align-items-center wow fadeInUp" data-wow-delay="300ms">
											...
											<div class="single-schedule-tumb-info d-flex align-items-center">
												<!-- Single Schedule Thumb -->
												<div class="single-schedule-tumb">
													<img src="<?= base_url('assets/'); ?>static_page/img/bg-img/11.jpg" alt="">
												</div>
												<!-- Single Schedule Info -->
												<div class="single-schedule-info">
										...
										<div class="single-schedule-area d-flex flex-wrap justify-content-between align-items-center wow fadeInUp" data-wow-delay="300ms">
											...
											<div class="single-schedule-tumb-info d-flex align-items-center">
												<!-- Single Schedule Thumb -->
												<div class="single-schedule-tumb">
													<img src="<?= base_url('assets/'); ?>static_page/img/bg-img/12.jpg" alt="">
												</div>
												<!-- Single Schedule Info -->
												<div class="single-schedule-info">
										...
										<div class="single-schedule-area d-flex flex-wrap justify-content-between align-items-center wow fadeInUp" data-wow-delay="300ms">
											...
											<div class="single-schedule-tumb-info d-flex align-items-center">
												<!-- Single Schedule Thumb -->
												<div class="single-schedule-tumb">
													<img src="<?= base_url('assets/'); ?>static_page/img/bg-img/13.jpg" alt="">
												</div>
												<!-- Single Schedule Info -->
												<div class="single-schedule-info">
	...
	<section class="our-ticket-pricing-table-area bg-img bg-gradient-overlay section-padding-100-0 jarallax" style="background-image: url(<?= base_url('assets/'); ?>static_page/img/bg-img/14.jpg);">
		<div class="container">
			<div class="row">
				<!-- Heading -->
				<div class="col-12">
			...
			<div class="row">
				...
				<div class="col-12 col-lg-4">
					<div class="single-ticket-pricing-table text-center mb-100 wow fadeInUp" data-wow-delay="300ms">
						...
						<div class="ticket-icon">
							<img src="<?= base_url('assets/'); ?>static_page/img/core-img/p1.png" alt="">
						</div>
				...
				<div class="col-12 col-md-6 col-lg-4">
					<div class="single-ticket-pricing-table active text-center mb-100 wow fadeInUp" data-wow-delay="300ms">
						...
						<!-- Ticket Icon -->
						<div class="ticket-icon">
							<img src="<?= base_url('assets/'); ?>static_page/img/core-img/p2.png" alt="">
						</div>
				...
				<div class="col-12 col-md-6 col-lg-4">
					<div class="single-ticket-pricing-table text-center mb-100 wow fadeInUp" data-wow-delay="300ms">
						...
						<!-- Ticket Icon -->
						<div class="ticket-icon">
							<img src="<?= base_url('assets/'); ?>static_page/img/core-img/p3.png" alt="">
						</div>
				...
				<div class="col-12">
					...
					<div class="our-sponsor-area d-flex flex-wrap">
						...
						<div class="single-sponsor wow fadeInUp" data-wow-delay="300ms">
							<a href="#"><img src="<?= base_url('assets/'); ?>static_page/img/core-img/p-1.png" alt=""></a>
						</div>
						<!-- Single Sponsor -->
						<div class="single-sponsor wow fadeInUp" data-wow-delay="300ms">
							<a href="#"><img src="<?= base_url('assets/'); ?>static_page/img/core-img/p-2.png" alt=""></a>
						</div>
						<!-- Single Sponsor -->
						<div class="single-sponsor wow fadeInUp" data-wow-delay="300ms">
							<a href="#"><img src="<?= base_url('assets/'); ?>static_page/img/core-img/p-3.png" alt=""></a>
						</div>
						<!-- Single Sponsor -->
						<div class="single-sponsor wow fadeInUp" data-wow-delay="300ms">
							<a href="#"><img src="<?= base_url('assets/'); ?>static_page/img/core-img/p-4.png" alt=""></a>
						</div>
						<!-- Single Sponsor -->
						<div class="single-sponsor wow fadeInUp" data-wow-delay="300ms">
							<a href="#"><img src="<?= base_url('assets/'); ?>static_page/img/core-img/p-5.png" alt=""></a>
						</div>
						<!-- Single Sponsor -->
						<div class="single-sponsor wow fadeInUp" data-wow-delay="300ms">
							<a href="#"><img src="<?= base_url('assets/'); ?>static_page/img/core-img/p-6.png" alt=""></a>
						</div>
						<!-- Single Sponsor -->
						<div class="single-sponsor wow fadeInUp" data-wow-delay="300ms">
							<a href="#"><img src="<?= base_url('assets/'); ?>static_page/img/core-img/p-7.png" alt=""></a>
						</div>
						<!-- Single Sponsor -->
						<div class="single-sponsor wow fadeInUp" data-wow-delay="300ms">
							<a href="#"><img src="<?= base_url('assets/'); ?>static_page/img/core-img/p-8.png" alt=""></a>
						</div>
					</div>
				</div>
								...
								<div class="single-client-text">
									...
									<div class="single-client-thumb-info d-flex align-items-center">
										...
										<div class="single-client-thumb">
											<img src="<?= base_url('assets/'); ?>static_page/img/bg-img/15.jpg" alt="">
										</div>
										<!-- Single client Info -->
							...
							<div class="single-client-content">
								...
								<div class="single-client-text">
									...
									<div class="single-client-thumb-info d-flex align-items-center">
										<!-- Single client Thumb -->
										<div class="single-client-thumb">
											<img src="<?= base_url('assets/'); ?>static_page/img/bg-img/16.jpg" alt="">
										</div>
										<!-- Single client Info -->
										<div class="client-info">
	...
	<!-- Our Blog Area Start -->
	<section class="our-blog-area bg-img bg-gradient-overlay section-padding-100-60" style="background-image: url(<?= base_url('assets/'); ?>static_page/img/bg-img/17.jpg);">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<!-- Heading -->
				...
				<div class="col-12 col-md-6 col-lg-4">
					<div class="single-blog-area wow fadeInUp" data-wow-delay="300ms">
						...
						<div class="single-blog-thumb">
							<img src="<?= base_url('assets/'); ?>static_page/img/bg-img/18.jpg" alt="">
						</div>
				...
				<div class="col-12 col-md-6 col-lg-4">
					<div class="single-blog-area wow fadeInUp" data-wow-delay="300ms">
						<!-- Single blog Thumb -->
						<div class="single-blog-thumb">
							<img src="<?= base_url('assets/'); ?>static_page/img/bg-img/19.jpg" alt="">
						</div>
						<div class="single-blog-text text-center">
				...
				<div class="col-12 col-md-6 col-lg-4">
					<div class="single-blog-area wow fadeInUp" data-wow-delay="300ms">
						<!-- Single blog Thumb -->
						<div class="single-blog-thumb">
							<img src="<?= base_url('assets/'); ?>static_page/img/bg-img/20.jpg" alt="">
						</div>
						<div class="single-blog-text text-center">
				...
				<div class="row">
					...
					<div class="col-12 col-sm-6 col-lg-3">
						<div class="single-footer-widget mb-60 wow fadeInUp" data-wow-delay="300ms">
							<!-- Footer Logo -->
							<a href="#" class="footer-logo"><img src="<?= base_url('assets/'); ?>static_page/img/core-img/logo.png" alt=""></a>
					...
					<div class="col-12 col-sm-6 col-lg-3">
						<div class="single-footer-widget mb-60 wow fadeInUp" data-wow-delay="300ms">
							...
							<div class="footer-gallery">
								<div class="row">
									<div class="col-4">
										<a href="img/bg-img/21.jpg" class="single-gallery-item"><img src="<?= base_url('assets/'); ?>static_page/img/bg-img/21.jpg" alt=""></a>
									</div>
									<div class="col-4">
										<a href="img/bg-img/22.jpg" class="single-gallery-item"><img src="<?= base_url('assets/'); ?>static_page/img/bg-img/22.jpg" alt=""></a>
									</div>
									<div class="col-4">
										<a href="img/bg-img/23.jpg" class="single-gallery-item"><img src="<?= base_url('assets/'); ?>static_page/img/bg-img/23.jpg" alt=""></a>
									</div>
									<div class="col-4">
										<a href="img/bg-img/24.jpg" class="single-gallery-item"><img src="<?= base_url('assets/'); ?>static_page/img/bg-img/24.jpg" alt=""></a>
									</div>
									<div class="col-4">
										<a href="img/bg-img/25.jpg" class="single-gallery-item"><img src="<?= base_url('assets/'); ?>static_page/img/bg-img/25.jpg" alt=""></a>
									</div>
									<div class="col-4">
										<a href="img/bg-img/26.jpg" class="single-gallery-item"><img src="<?= base_url('assets/'); ?>static_page/img/bg-img/26.jpg" alt=""></a>
									</div>
								</div>
							</div>
						</div>
	...
	<!-- **** All JS Files ***** -->
	<!-- jQuery 2.2.4 -->
	<script src="<?= base_url('assets/'); ?>static_page/js/jquery.min.js"></script>
	<!-- Popper -->
	<script src="<?= base_url('assets/'); ?>static_page/js/popper.min.js"></script>
	<!-- Bootstrap -->
	<script src="<?= base_url('assets/'); ?>static_page/js/bootstrap.min.js"></script>
	<!-- All Plugins -->
	<script src="<?= base_url('assets/'); ?>static_page/js/confer.bundle.js"></script>
	<!-- Active -->
	<script src="<?= base_url('assets/'); ?>static_page/js/default-assets/active.js"></script>
