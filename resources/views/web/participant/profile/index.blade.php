...
@section('content')
<h1>Profile</h1>
<form action="{{route('participant.profile.update', $participant->id)}}" method="post" id="registration">
    @csrf
    @method('put')
    <div class="row">
        <div class="col-md-6">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <x-forms.input-date id="birth_of_date" name="birth_of_date" value="{{$participant->birth_of_date}}"
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <x-forms.input id="city" name="city" value="{{$participant->city}}" placeholder="City" inputgroup="append"
                inputgroupicon="fas fa-city" />

            <x-forms.input id="zip_code" name="zip_code" value="{{$participant->zip_code}}" placeholder="Zip Code"
