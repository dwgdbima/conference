                ...
                <table class="content" width="100%" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td class="header"
                            ...
                            <img src="http://icemineupnyk.com/assets/dist/img/logo2.png" alt="{{config('app.name')}}"
                                style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 26%;max-width: 150.28px;"
                                width="150.28">
                            <a href="{{ url('/') }}"
